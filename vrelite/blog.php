      ...
      <div class="container">
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            <p>
            <!-- Link back to Logistics can't be removed. Template is licensed under CC BY 3.0. -->
                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | by Logistics</a>
            <!-- Link back to Logistics can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
            </div>
          </div>
